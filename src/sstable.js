...
class SSTable {
	...
	/**
	 * Loads an SSTable from a serialized buffer
	 * 
	 * @param buf should be an ArrayBuffer
	 */
	constructor(buf) {
		// Supporting nodejs (conversion from Buffer to ArrayBuffer) 
		...
		this._bins.push({ off: buf.byteLength });
	}
